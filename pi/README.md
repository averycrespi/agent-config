...
| [subagents](agent/extensions/subagents/README.md)                 | Delegate self-contained questions to isolated child agents                  | `subagents` (foreground/background and lifecycle controls)                                                                   |
