...
| [background](agent/extensions/background/README.md)               | Bound polling, typed session events, and settlement-based continuation | `background`, `/background-config`, [provider API](agent/extensions/background/API.md)                                       |
