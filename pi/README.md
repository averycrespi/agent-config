...
| [mcp-gateway](agent/extensions/mcp-gateway/README.md)             | Access authenticated external services through a gateway               | `mcp_search`, `mcp_describe`, `mcp_call`, optional [Script provider](agent/extensions/mcp-gateway/API.md#script-provider) |
