...
A pending question retains the current child as sole owner and blocks successor launch. Cancel/reconcile continuation for affected blocked work; do not open modal ask-user or automatically replace the child. Record answers and relay intent in the shared project record; submission alone does not prove application. Preserve unanswered and answered-awaiting-confirmed-relay questions across replacement, without resetting budgets or replaying prompts.
