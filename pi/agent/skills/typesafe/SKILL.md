...
license: MIT
description: >
  Use when building or updating a TypeSafe AI integration, evaluating TypeSafe
  for a feature, or explicitly brainstorming with TypeSafe. Covers live API and
  SDK documentation, typed judgments, probabilities, and composing routing,
  ranking, extraction, and verification workflows in code.
---
