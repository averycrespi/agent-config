...
- renders one contextual tool/action result line with list counts or explicit failure, not task-text previews or a completion checkmark; expansion retains full task text and model-facing details are unchanged
