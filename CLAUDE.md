...
The Claude Code configuration lives in a separate private repository.
...
- **Workflow skills** (invoked to perform a task): use verb-object names when natural, or concise task names for broad workflows (e.g., `clarify`, `plan`)
