...
- **Fetch.** Official GitHub MCP tools exposed through the broker, such as `mcp__mcp-broker__github_get_file_contents` and `mcp__mcp-broker__github_pull_request_read`.
